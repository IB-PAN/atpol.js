...
test("Darwin Core fields", () => {
	...
	expect(fields.decimalLatitude).toBe("50.381008");
	expect(fields.decimalLongitude).toBe("20.813346");
	...
	expect(fields.georeferenceProtocol).toBe("Coordinates represent the centroid of an ATPOL 2×2 km grid cell");
